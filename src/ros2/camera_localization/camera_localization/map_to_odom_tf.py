...
class MapToOdomTF(Node):
    ...
    def initial_pose_callback(self, msg):
        ...
        # Извлекаем угол yaw из кватерниона
        # q = msg.pose.orientation
        # angles = R.from_quat(q).as_euler(seq='xyz', degrees=False)
        # initial_yaw = angles[2]
        self.get_logger().info(f"Initial pose set: x={initial_x}, y={initial_y}")
