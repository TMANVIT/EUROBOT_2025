...
class MapToOdomTF(Node):
    ...
    def initial_pose_initialisation(self, msg):
        self.inital_pose_coords = np.array([msg.pose.pose.position.x, msg.pose.pose.position.y, msg.pose.pose.position.z])
        self.inital_pose_rotation = np.array((R.from_quat(np.array([msg.pose.pose.orientation.x, msg.pose.pose.orientation.y, msg.pose.pose.orientation.z, msg.pose.pose.orientation.w]))).as_matrix())
